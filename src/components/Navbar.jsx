...
const Navbar = ({ modal, setModal }) => {
  ...
  <div>
    <div className=" h-[145px] lg:hidden">hello</div>
     <div className={up ?  " fixed top-[-44px]  lg:top-[-64px] w-full z-[1000]"  :  " absolute  top-0   w-full z-[1000]" } >
            ...
            <div className="">
              <div className=" flex lg:gap-6 gap-2 items-center">
                ...
                <div className=" flex gap-2">
                  ...
                  <p className=" text-white font-bold hidden md:block">Login</p>
                </div>
                <div className=" flex gap-2">
                  <BsFillPersonFill className=" text-[#468ae7] text-2xl" />
                  <p className=" text-white font-bold hidden md:block">Signup</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className={up ? "lg:opacity-80 bg-black   w-full   h-[80px] items-center   " : "lg:opacity-60 bg-black   w-full   h-[80px] items-center   "}>
        <div className=" max-w-[1180px]  mx-auto ">
