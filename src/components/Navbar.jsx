  ...
  return (
    <div className=" relative">
          ...
          <div className=" flex items-center  w-full ">
            <div className="flex items-center gap-[20px] ml-auto lg:ml-0 md:ml-auto  md:gap-[20px]">
              <NavLink
                ...
                to={`/`}
                className="h-[15vh] active items-center   border-b-blue-500 hover:border-b-[2px]  text-white hidden xl:flex lg:flex  md:hidden  cursor-pointer"
              >
                {" "}
                Home
              </NavLink>
      ...
      <div   className="  fixed  bg-black p-1 lg:p-4 z-[1000]  md:p-1  w-full opacity-80  ">
        ...
        {/* className="z-50 p-2 mb-[40px] flex  lg:gap-[180px] xl:gap-[280px] gap-[70px] md:gap-[80px] mx-[20px] lg:mx-[180px] xl:mx-[190px] md:mx-[0px] justify-center md:justify-start lg:justify-between xl:justify-normal  items-center h-[10vh]  lg:mt-10 xl:mt-10 mt-5 md-mt-5 " */}
        <div className=" z-50 flex p-2 justify-between items-center w-[90%] mx-auto   h-[10vh]  lg:mt-10 xl:mt-10 mt-5 mb-[25px]">
          <div className=" ">
            <img
              src="https://a6e8z9v6.stackpathcdn.com/traveltour/wp-content/themes/traveltour/images/logo.png"
              alt=""
          ...
          <div className=" flex items-center   ">
            <div className="flex items-center ">
              ...
              <NavLink className=" relative ">
                ...
                <Menu
                  className=" items-center  h-[120px] hover:bg-transparent hover:border-b-2 rounded-none hover:border-blue-500 border-l-0 border-t-0 border-r-0 text-white hidden xl:flex lg:flex  md:hidden  cursor-pointer"
