...
const About = () => {
  ...
  return (
    ...
    <div className=' bg-about-main bg-cover bg-center h-[200px] md:h-[499px] w-auto relative'>
        ...
        <p className=' h-1 font-bold text-3xl md:text-6xl absolute top-16 left-10 md:top-64 md:left-32 text-white'>About Us</p>
        <p className=' h-1 font-bold text-lg md:text-2xl absolute top-28 left-10 md:top-80 md:left-32 text-white'>Justo Vulputate Vehicula</p>
    ...
    <div className=' h-auto md:h-[450px] grid grid-cols-1 md:grid-cols-2 px-10 py-10 md:p-20'>
        ...
        <div className=' md:w-[300px] lg:w-[400px]'>
            <p className=' font-extrabold text-4xl text-gray-800'>Amet Etiam Quam</p>
            <p className=' pt-5 text-slate-500'>Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Maecenas sed diam eget risus varius blandit sit amet non magna. Maecenas sed diam eget risus varius blandit sit amet non magna.</p>
        </div>
        <div className=' mt-5 md:mt-0'>
            <div>
                <div className=' flex items-center justify-between'>
                    <p className=' uppercase text-gray-800 pt-3 text-lg font-medium'>Branding</p>
                    <p className=' uppercase text-gray-800 pt-3 text-lg font-medium'>90%</p>
                </div>   
                <div className="relative pt-3">
                    <div className="overflow-hidden h-[6px] mb-4 text-xs flex rounded" style={{ background: '#f3f3f3' }}>
                        <div style={{ width: "90%", background: 'rgb(22, 22, 22)' }} className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center"></div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div className=' flex items-center justify-between'>
                    <p className=' uppercase text-gray-800 pt-3 text-lg font-medium'>Graphic Desgin</p>
                    <p className=' uppercase text-gray-800 pt-3 text-lg font-medium'>100%</p>
                </div>   
                <div className="relative pt-3">
                    <div className="overflow-hidden h-[6px] mb-4 text-xs flex rounded" style={{ background: '#f3f3f3' }}>
                        <div style={{ width: "100%", background: 'rgb(22, 22, 22)' }} className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center"></div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div className=' flex items-center justify-between'>
                    <p className=' uppercase text-gray-800 pt-3 text-lg font-medium'>Social Marketing</p>
                    <p className=' uppercase text-gray-800 pt-3 text-lg font-medium' style={{ transition: "all 0.5s ease-out" }}>{social <= 85 ? social : '85'}%</p>
                </div>   
                <div className="relative pt-3">
                    <div className="overflow-hidden h-[6px] mb-4 text-xs flex rounded" style={{ background: '#f3f3f3' }}>
                        <div ref={refSocial} style={{ width: "0%", background: 'rgb(22, 22, 22)', transition: "all 0.5s ease-out" }} className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center"></div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div className=' flex items-center justify-between'>
                    <p className=' uppercase text-gray-800 pt-3 text-lg font-medium'>Product Desgin</p>
                    <p className=' uppercase text-gray-800 pt-3 text-lg font-medium'>{product <= 90 ? product : '90'}%</p>
                </div>   
                <div className="relative pt-3">
                    <div className="overflow-hidden h-[6px] mb-4 text-xs flex rounded" style={{ background: '#f3f3f3' }}>
                        <div ref={refProduct} style={{ width: "0%", background: 'rgb(22, 22, 22)', transition: "all 0.5s ease-out" }} className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div className=' grid grid-cols-1 md:grid-cols-2 relative'>
        <div  className='w-full h-[360px] md:h-[925px] lg:h-[690.238px] bg-fixed overflow-hidden'>
            <img ref={refTran} style={{ transform : `translate(0px, ${tran}px)` }} className='h-full w-full bg-cover bg-center' src="https://a6e8z9v6.stackpathcdn.com/traveltour/wp-content/uploads/2016/06/shutterstock_74901229.jpg" alt="" />
        </div>
    ...
    <div style={{ backgroundColor: '#e1e1e1' }}>
        <p className=' text-center text-slate-800 text-5xl font-bold py-10'>Meet The Team</p>

        <div className=' px-20 py-10 flex flex-wrap gap-8'>
            {teamMember?.map((member,index) => {
                return (
                    <div key={index} className='w-[330px] md:w-[300px] lg:w-[342.33px] h-auto relative' style={{ backgroundColor: '#fff' }}>
                        <div className=' h-[312.11px] overflow-hidden'>
                            <img className=' w-full h-full' src={member?.src} alt="" />
                            <div className="overlay-about "></div>
                        </div>
                        <div className=' px-16 py-5'>
                            <p className=' text-gray-800 text-xl font-bold py-5'>{member?.title}</p>
                            <p className=' text-slate-400 text-lg mb-5'>{member?.field}</p>
                        </div>
                    </div>
                )
            })}
